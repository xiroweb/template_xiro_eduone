...
function pagination_item_active(&$item)
{
	...
	{
		$display = '<i class="material-icons pmd-xs">skip_previous</i>';
	...
	{
		$display = '<i class="material-icons pmd-xs">navigate_before</i>';
		$aria    = JText::sprintf('JLIB_HTML_GOTO_POSITION', strtolower($item->text));
	}
	...
	{
		$display = '<i class="material-icons pmd-xs">navigate_next</i>';
		$aria    = JText::sprintf('JLIB_HTML_GOTO_POSITION', strtolower($item->text));
	}
	...
	{
		$display = '<i class="material-icons pmd-xs">skip_next</i>';
		$aria    = JText::sprintf('JLIB_HTML_GOTO_POSITION', strtolower($item->text));
	}
